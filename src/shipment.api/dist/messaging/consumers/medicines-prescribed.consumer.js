...
var MedicinesPrescribedConsumer_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.MedicinesPrescribedConsumer = void 0;
...
let MedicinesPrescribedConsumer = MedicinesPrescribedConsumer_1 = class MedicinesPrescribedConsumer {
    constructor(serviceBusService, configService, commandBus, shipmentRepository) {
        this.serviceBusService = serviceBusService;
        this.configService = configService;
        this.commandBus = commandBus;
        this.shipmentRepository = shipmentRepository;
        this.logger = new common_1.Logger(MedicinesPrescribedConsumer_1.name);
    }
    onModuleInit() {
        const client = this.serviceBusService.getClient();
        if (!client) {
            this.logger.warn('Service Bus not available - MedicinesPrescribed consumer disabled');
            return;
        }
        const topicName = this.configService.get('serviceBus.topics.medicinesPrescribed');
    ...
    async handleMessage(message) {
        ...
        this.logger.log(`Received MedicinesPrescribed message: ${messageId}`);
        ...
        try {
            ...
            await this.receiver.completeMessage(message);
            this.logger.log(`MedicinesPrescribed processed successfully: ${messageId}`);
        }
        catch (error) {
            this.logger.error(`Failed to process MedicinesPrescribed: ${error.message}`);
...
exports.MedicinesPrescribedConsumer = MedicinesPrescribedConsumer;
exports.MedicinesPrescribedConsumer = MedicinesPrescribedConsumer = MedicinesPrescribedConsumer_1 = __decorate([
...
//# sourceMappingURL=medicines-prescribed.consumer.js.map